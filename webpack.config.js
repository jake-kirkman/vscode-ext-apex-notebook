...
module.exports = (env, argv) => [
    makeConfig(argv, { entry: './src/renderers/apex/index.tsx', out: './out/renderers/apex/index.js', target: 'web', library: 'module' }),
    makeConfig(argv, { entry: './src/renderers/soql/index.tsx', out: './out/renderers/soql/index.js', target: 'web', library: 'module' }),
